...
def main():
    ...
    parser.add_argument('img_path', help="test image path", nargs='?', default="/mnt/quedoulin/github_code/yolov5/data/images/bus.jpg")
    parser.add_argument('onnx_path', help="onnx model file path", nargs='?', default="yolov3-416-v9.onnx")
    ...
    parser.add_argument('--isTiny',help="to choice anchors",nargs='?', default=True, type=bool)
    ...
    cv2.imwrite('test_yolov3_infer.jpg', img)
